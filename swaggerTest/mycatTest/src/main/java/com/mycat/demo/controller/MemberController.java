...
public class MemberController {
    ...
    @ApiOperation(nickname = "selectAll",value="查询所有",httpMethod = "POST")
    @ResponseBody
    ...
    @ApiOperation(nickname = "updateMember",value="用户修改",httpMethod = "POST")
    @ResponseBody
    ...
    @ApiOperation(nickname = "deleteMember",value="删除用户",httpMethod = "POST")
    @ResponseBody
